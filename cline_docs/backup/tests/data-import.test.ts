...
describe('Data Import Utilities', () => {
  ...
  describe('Episode Import', () => {
    it('should import episodes with valid slugs', async () => {
    ...
    it('should handle duplicate episode titles by appending numbers', async () => {
      clearSlugRegistry(); // Ensure clean state
      const episodes = await importEpisodes(
        'project/current-site-data/English/CRO.CAFE - Episodes.csv',
        'en'
      );
      const duplicateEpisodes = await importEpisodes(
        'project/current-site-data/English/CRO.CAFE - Episodes.csv',
        'en'
      );
  ...
  describe('People Import', () => {
    it('should import people with valid slugs', async () => {
  ...
  describe('Platform Import', () => {
    it('should import platforms with valid slugs', async () => {
      const platforms = await importPlatforms(
  ...
  describe('Quote Import', () => {
    it('should import quotes with valid slugs', async () => {
